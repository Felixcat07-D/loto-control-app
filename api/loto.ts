...
export default async function handler(
  ...
  const prompt = `Tu tarea es encontrar los resultados del sorteo de lotería "Loto Plus" de Argentina número ${drawNumber}.
1.  **Fuente Principal (Oficial):** Busca los resultados directamente en el sitio oficial: https://loto.loteriadelaciudad.gob.ar/
